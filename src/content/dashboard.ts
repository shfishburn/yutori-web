export const DASHBOARD = {
  ...
  profileDescription: 'Your biometric data and equipment preferences.',
  ...
  profileAgeLabel: 'Age',
  profileAgePlaceholder: 'e.g. 35',
  profileWeightLabel: 'Weight (kg)',
  profileWeightLabelImperial: 'Weight (lbs)',
  profileWeightPlaceholder: 'e.g. 75',
  profileWeightPlaceholderImperial: 'e.g. 165',
  profileHeightLabel: 'Height (cm)',
  profileHeightLabelImperial: 'Height',
  profileHeightPlaceholder: 'e.g. 178',
  profileHeightFtPlaceholder: 'ft',
  profileHeightInPlaceholder: 'in',
  profileUnitsLabel: 'Units',
  profileUnitsImperial: 'Imperial',
  profileUnitsMetric: 'Metric',
  profileRestingHrLabel: 'Resting HR (bpm)',
  profileRestingHrPlaceholder: 'e.g. 62',
  profileBodyFatLabel: 'Body fat %',
  profileBodyFatPlaceholder: 'e.g. 18',
  profileSaunaTypeLabel: 'Sauna type',
  profileSaunaFinnish: 'Finnish 🪵',
  profileSaunaInfrared: 'Infrared 🔴',
  profileSaunaSteam: 'Steam ♨️',
  profileRltEnabledLabel: 'Red-light therapy',
  profileRltEnabledDescription: 'Enable RLT panel tracking during sessions.',
  profileLoadError: 'Could not load profile.',

  // Equipment preset (matches mobile onboarding)
  profileEquipmentLabel: 'Equipment',
  profilePresetPulse: 'Pulse Sauna',
  profilePresetPulseBy: 'by Yutori Labs',
  profilePresetPulseSpec1: 'Saunum Air 7.5 Finnish heater',
  profilePresetPulseSpec2: 'SaunaMAX Pro 320 W red / NIR panel',
