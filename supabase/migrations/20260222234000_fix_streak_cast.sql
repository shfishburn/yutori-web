-- ═══════════════════════════════════════════════════════════════════
-- Fix: cast row_number() bigint → int in streak CTE  (d - rn::int)
-- The original gamification_v1 migration was deployed before this
-- cast was added to the local file.  CREATE OR REPLACE is safe.
-- ═══════════════════════════════════════════════════════════════════
